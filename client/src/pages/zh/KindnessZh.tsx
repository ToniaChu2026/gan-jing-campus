...
const stories = [
  ...
  {
    title: "善念點亮台灣 — 師鐸獎教師的故事",
    location: "台灣屏東",
    teacher: "陳靜容",
    school: "潮昇國小 · 2025師鐸獎得主",
    summary:
      "從事教學27年的陳靜容老師，帶領學生參與『善良很酷』活動。班上同學手骨裂開刀，其他同學主動幫忙拿書、拿作業本、拿便當、拿書包，全班29個孩子還完成舞蹈拍攝，善行影片登上紐約時代廣場。學力檢測達到全學年最高。2025年，她獲得台灣教育界最高榮譽『師鐸獎』，由總統賴清德親自頒獎。",
    quote:
      "透過一個數位平台，是把孩子的視野是打開的。我在屏東做，我是沒有侷限性，我還是一樣跟美國波士頓的資優班的小朋友，一起在做這件事情。",
    impact: ["2025師鐸獎", "善行影片登上時代廣場", "學力檢測全學年最高", "善念點亮台灣"],
    color: "border-l-sky",
